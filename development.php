...
<?php include __DIR__.'/inc/menu.inc'; ?>
  <div class="center-h" id="container">
    <div id="main-content">
      ...
      <p><a href="https://bitbucket.org/grelminar/asss/">A Small Subspace Server (ASSS)</a></p>
      <p><a href="https://github.com/Ceiu/hyperspace-asss">Canonical Hyperspace zone modules and configuration repository</a><br>
        Have a look at <a href="http://wiki.minegoboom.com/index.php?title=Writing_Modules_for_Hyperspace&oldid=5869">Writing Modules for Hyperspace</a> on the ASSS wiki.</p>
      <p><a href="https://github.com/Ceiu/hyperspace-items">Authoritative JSON config for Hyperspace items</a><br>
        <a href="https://github.com/CDB-Man/hyperspace-items">CDB-Man's branch of the items JSON</a></p>
      <a name="website"></a>
      <h2>Website</h2>
      <p><a href="https://github.com/jstnryan/hs-website">Website source</a>.</p>
      <a name="bot"></a>
      <h2>Monkeybot</h2>
      <p><a href="https://github.com/plushmonkey/monkeybot">Continuum Screen Bot</a></p>
      <a name="other-dev"></a>

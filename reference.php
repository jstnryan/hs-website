...
<?php include 'inc/menu.inc'; ?>
  <div class="center-h container" id="container">
    <div id="main-content">
      ...
      <div class="tut">
        <ul>
          <li><b>Use common sense. If you think it might be wrong, it probably is. Hyperspace staff reserve the right to spontaneously declare new rules to address whatever stupid thing you might be trying to do.</b></li>

<?php
  ...
  //Updated by Justin Ryan (sigma13, theEND!) 2015.10.03, jstn@jstnryan.com
...
print "teamelim: $fb[playing] playing, $fb[spec] spectating, $fb[total] logged in.\n";
*/
...
*/
  ...
  { //For PHP5
    $this->host = $host;
    $this->port = $port + 1; //ASSS listens on next port

<?php
$pagetitle = 'Special Events (Legacy)';
  ...
  <div class="center-h" id="container">
    <div id="main-content">
      ...
      <div class="tut">
        ...
        <p>Special Events are typically hosted by online staff when they feel that hosting such an event is appropriate. Special Events are generally prized, with the winners being rewarded with Hyperspace money ($100 - $10000) or a <a href="article7.php">'one time use' item</a>, depending on the event. Here is a brief guide to the types of events currently being hosted by Hyperspace staff.</p>

    ...
    <div id="main-content">
      ...
      <div class="tut">
        <table cellspacing="0">
          ...
          <tbody>
            <tr>
              <td><!--<a href="/tools/browser.php#ship-browser">-->Ship Browser<!--</a>--></td>
            ...
            <tr>
              <td><!--<a href="/tools/browser.php#item-browser">-->Item Browser<!--</a>--></td>
            ...
            <tr>
              <td><a href="/build.php">Ship Builder</a></td>
